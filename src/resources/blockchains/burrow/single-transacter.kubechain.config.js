        ...
        hooks: {
            createdRepresentations: function (data) {
                ...
                if (data.representations) {
                    data.representations.forEach((representation) => {
                        validatorAddresses.push(Naming.fullyQualifiedDomainName(Naming.toDNS1123(representation.name), data.service, data.namespace));
                    })
                }
            },
            workload: {
