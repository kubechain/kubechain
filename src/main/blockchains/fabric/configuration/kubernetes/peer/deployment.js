...
const HostPathVolume = require('../../../../../kubernetes-sdk/resourceobjects/storage/hostpath');
...
class PeerDeployment {
    constructor(organization, peer, organizationName, name) {
        ...
        this._deployment = new Deployment(this._podName, this._namespace);
        this._deployment.addLabel("app", "hyperledger");
        this._deployment.addLabel("role", "peer");
        this._deployment.addLabel("peer-id", this._peerID);
        this._deployment.addLabel("org", this._org);
